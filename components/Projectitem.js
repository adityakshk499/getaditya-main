...
const Projectitem = ({imagesrc,technology,demo,nam}) => {
  return (
    <>
      <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 border border-gray-600 rounded-xl group hover:bg-gradient-to-r from-[#006a91] to-[#00D8FF]">
        <img
